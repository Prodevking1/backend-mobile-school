...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <body>
     <div class="max-w-md mx-auto bg-white rounded-lg overflow-hidden md:max-w-xl">
         <div class="md:flex">
           <div class="w-full p-4 px-3 py-2">
             <div class="mb-4">
                 <label for="filiere" class="block text-gray-700 font-bold mb-2">
                     Filiere
                 </label>
                 <select id="filiere" name="filiere" class="w-full border border-gray-300 p-2 rounded-lg">
             ...
             <div class="text-center">
               <button
                 type="submit"
                 class="w-full rounded-3xl bg-blue-500 hover:bg-blue-600 px-6 py-2 text-xl font-medium uppercase text-white"
               >
                 Upload
               </button>
             </div>
